  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display tracking-wide",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-[hsl(185_100%_50%)] text-primary-foreground font-bold uppercase tracking-wider hover:shadow-[0_0_30px_hsl(var(--primary)/0.6)] transition-all duration-300",
        neon: "bg-transparent border-2 border-accent text-accent hover:bg-accent/10 hover:shadow-[0_0_20px_hsl(var(--accent)/0.5)] font-mono uppercase tracking-widest",
        terminal: "bg-card border border-accent/50 text-accent font-mono hover:border-accent hover:shadow-[0_0_15px_hsl(var(--accent)/0.3)]",
      },
      size: {
